...
export const getTranslations = async (locale: string, namespace: string) => {
    const t = await getNextTranslations({locale, namespace: namespace as any}) as TranslationFunction
    return ( key: string, args: Record<string, string | number | Date> = {}, _message: string ) => t(key, args)
}
