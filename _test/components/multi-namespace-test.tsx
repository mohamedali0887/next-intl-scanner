...
const MultiNamespaceTest = () => {
    ...
    return (
        <div className="w-full">
            ...
            <FormattedMessage namespace="common" string="select-status" key="select-status" />
            <FormattedMessage namespace="common" string="all" key="all" />

            {/* Another FormattedMessage with different namespace */}
            <FormattedMessage namespace="validation" string="Required Field" key="required-field" />
        </div>
    );
};
